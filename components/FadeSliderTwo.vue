<template>
    <div class="container" ref="containerRef">
        <div class="lg:h-[500px] px-10 max-lg:py-10 lg:py-24 w-full text-white relative rounded-3xl overflow-hidden">
            <div class="w-full h-full absolute top-0 start-0 bg-[#233F94CC] z-10"></div>
            <Transition name="fade" mode="out-in">
                <div class="w-full h-full absolute top-0 start-0 z-0 rounded-3xl overflow-hidden" v-if="data[selectedIndex]" :key="selectedIndex">
