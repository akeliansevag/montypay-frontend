<template lang="">
    <header :class="$route.path === '/' ? 'fixed' : 'sticky'" class="top-0 left-0 w-full z-30 transition-all duration-300 ease-in-out shadow-md">
            ...
            <div class="container flex justify-between items-center">
                ...
                <div class="flex items-center gap-4 lg:gap-7">
                    ...
                    <div @click="toggleNav" class="menu-btn block lg:hidden pt-1.5 pb-2.5 text-3xl cursor-pointer">
                        <Icon v-if="!navVisible" name="fa6-solid:bars" class="icon text-lg" :class="$route.path !== '/' ? 'text-blacsk': 'text-primary'" />
