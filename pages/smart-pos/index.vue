                                ...
                                <div v-if="activeFilter === 'F20'">
                                    ...
                                    <div class="gap-10 mt-5">
                                        <ul class="custom-list">
                                            <li>Quad-Core Processor (4 x 1.3GHz) for fast, smooth operation </li>
                                            <li>Wi-Fi, 4G, and Bluetooth connectivity for flexible use </li>
                                            <li>High-speed printer for quick receipts </li>
                                            <li>Long-lasting battery  </li>
                                        </ul>
                                    
                                    </div>
                                    <p class="mt-5 font-bold">Perfect for businesses needing robust, all-in-one payment solutions. </p>
                                </div>

                                <div v-if="activeFilter === 'F210'">
                                    <p class="font-bold">Medium - Smart, Compact, and Cost-Effective POS Terminal</p>
                                    <p class="mt-4">A sleek and affordable POS device designed for businesses looking for efficiency, security, and omnichannel payment capabilities. Powered by Android 10 and a high-performance Quad-Core processor, the F210 ensures fast transactions, seamless connectivity, and a user-friendly experience.</p>
                                    <div class="gap-10 mt-5">
                                        <ul class="custom-list">
                                            <li>5-inch HD touchscreen for a clear and responsive interface</li>
                                            <li>Wi-Fi, 4G, 3G, and Bluetooth for reliable connectivity anywhere</li>
                                            <li>High-speed thermal printer for smooth, quick receipts (58mm roll size)</li>
                                            <li>Advanced security & multi-card support including NFC, IC, magstripe, and QR payments</li>
                                        </ul>
                                    
                                    </div>
                                    <p class="mt-5 font-bold">Ideal for retail, hospitality, and service industries that need a compact yet powerful payment solution without compromising on performance.</p>
                                </div>

                                <div v-if="activeFilter === 'F300'">
                                    <p class="font-bold">Small - Compact & Reliable POS Device</p>
                                    <p class="mt-4">A compact, pocket-sized POS solution designed for businesses on the move. It offers reliable connectivity for seamless transactions with 4G/3G/2G, Wi-Fi, and Bluetooth 4.2. Powered by a Quad-Core processor, it provides fast performance across various payment methods. </p>
                                    <div class="gap-10 mt-5">
                                        <ul class="custom-list">
                                            <li>Smaller, smarter design for efficient use in diverse environments </li>
                                            <li>Proven durability with reliability tests for harsh conditions </li>
                                            <li>Perfect for restaurants, retail, transportation, and public utilities. </li>
                                        </ul>
                                    
                                    </div>
                                    <p class="mt-5 font-bold">Great for businesses seeking portability without sacrificing performance. </p>
                                </div>
        ...
        <div class="container">
            <div class="flex max-lg:flex-col gap-10 lg:justify-between lg:items-center">
                <div class="lg:w-1/2">
                    ...
                    <p class="mt-5">A perfect pairing for growing businesses that want simplicity and efficiency across all sales channels.  </p>
...
<script setup>
    ...
    const whySmartPos = [
        ...
        },
        {
            ...
            description: 'Accept a wide range of payment options, from credit cards to digital wallets, supporting customer convenience.',
        },
        {
            ...
            description: 'Allow customers to split transactions effortlessly, improving their experience.',
        },
        {
            ...
            description: 'Track sales and access real-time reporting to optimize operations.',
        },
        {
            ...
            description: 'Build customer loyalty with customizable rewards.',
        },
        {
            ...
            description: 'Rely on around-the-clock assistance for uninterrupted service.',
        },
        {
            ...
            description: 'Boost sales by offering flexible payment plans.',
        },
        {
            ...
            description: 'Seamlessly connect with cash registers and inventory management systems.',
        },
        {
            ...
            description: 'Expand your business by offering popular extras like eSIMs, streaming subscriptions (Netflix, Anghami), gaming vouchers (PUBG Mobile, Xbox), and mobile top-ups—all directly from your POS.',
        },
    ]
