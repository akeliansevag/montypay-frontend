            ...
            <div class="container">
                <div class="mt-16 text-primary">
                    <div class="flex flex-col gap-8 border rounded-lg py-20 px-20 bg-quaternary overflow-hidden">
                        ...
                        <button @click="submitRequest" class="mp-button-secondary px-16">Connect to PayPal <Icon name="fa6-solid:arrow-right" class="icon rtl:rotate-180 transition-transform" /></button>
