    ...
    <div>
        ...
        <section id="section-6" class="py-16 lg:py-36">
            <div class="container">
                <ContentBlock 
                    title="Plugins & SDKs"
                    paragraph="Plug into the power of MontyPay's supercharged Plugins and Software Development Kits (SDKs) for a payment experience that's out of this world"
                    class="text-center"
                />
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-16">
                    ...
                    <div class="lg:col-span-2 gap-8 border border-[#d1d1d1] rounded-lg py-8 px-6 bg-primary">
                        <div class="flex flex-col gap-12">
                            ...
                            <div class="w-full grid grid-cols-3 gap-4 items-center place-content-center mt-12 lg:mt-0">
                                <NuxtPicture 
                                    priority
                                    format="svg" 
                    ...
                    <div class="gap-8 border border-[#d1d1d1] rounded-lg py-8 px-6 bg-primary">
                        <div class="flex flex-col gap-12">
                            ...
                            <div class="w-full grid grid-cols-2 gap-4 items-center place-content-center mt-12 lg:mt-0">
                                <NuxtPicture 
                                    priority
                                    format="svg" 
...
<script setup>
    useSeoMeta({
        ...
        ogTitle: 'Online Payment Solutions',
        description: 'Experience Seamless Transactions with MontyPay\'s Effortless Online Payment Solutions ensuring convenient, risk-free payments, enhancing trust and confidence.',
        ogDescription: 'Experience Seamless Transactions with MontyPay\'s Effortless Online Payment Solutions ensuring convenient, risk-free payments, enhancing trust and confidence.',
